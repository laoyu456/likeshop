...
<view class="user-fans-box">
    <view class="header">
        <view class="top-bar row bg-white md">
            ...
            <view :class="'bar-item row-center ' + (active == 'first' ? 'item-active' : '')" @tap="changeTab" data-active="first">一级推广</view>
            <view :class="'bar-item row-center ' + (active == 'second' ? 'item-active' : '')" @tap="changeTab" data-active="second">二级推广</view>
        </view>         
        <u-search 
            v-model="keyword" 
            shape="round"
