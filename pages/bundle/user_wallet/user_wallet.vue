    ...
    <view class="contain bg-white mb20">
        <view class="header">
            ...
            <view class="money white row">
                ...
                <view v-if="wallet.open_racharge" style="height: 58rpx;" class="row-center primary bg-white br60 btn" size="xs" @click="goPage"  >充值</view>
            </view>
        </view>
        <view class="nav row">
            ...
            <navigator class="nav-item column-center" hover-class="none" url="/pages/bundle/user_bill/user_bill?type=1">
                <image src="/static/images/icon_consume.png"></image>
                <view class="mt10">消费记录</view>
            </navigator>
            <navigator class="nav-item column-center" hover-class="none" url="/pages/bundle/user_bill/user_bill?type=2">
...
export default {
  ...
  methods: {
    goPage(e) {
        goToPay('/pages/bundle/user_payment/user_payment')
    },
