            ...
            <form>
                <view class="user-apply-vip column-center">
                    ...
                    <view class="vip-form">
                        ...
                        <view class="form-item row ">
                            <view class="label md">手机号码：</view>
                            <input class="md" name="mobile" v-model="mobile" placeholder="请输入您的手机号码"></input>
                        </view>
                        ...
                        <view class="form-item bg-white row" style="height: 74px;padding: 24rpx 20rpx 24rpx 30rpx">
                            <view class="label md" style="width: 206rpx;align-self: flex-start;">申请原因：</view>
                            <textarea name="reason" style="height: 150rpx;" type="textarea" fixed="true" placeholder="（必填）" border="false" title-width="150rpx" @input="textareaChange" />
                        </view>
                    </view>
                </view>
        ...
        <view :hidden="vipState!=1" class="user-result-box">
            <view class="user-result column-center">
                ...
                <view class="user-result-content column-center">
                    <image class="apply-result-img" src="/static/images/icon_paySuccess.png"></image>
        ...
        <view :hidden="vipState!=2" class="user-vip">
            <view class="user-assets-box">
                ...
                <view class="user-assets-content row wrap">
                    ...
                    <view class="user-item column-center">
                        <view class="nr user-assets-name row" style="color: #8F430E">本月预估收益<u-icon class="ml10" name="question-circle" size="30rpx" color="#D88D5A" /></view>
                        <view class="assets ml20">
                    ...
                    <view class="user-item column-center">
                        <view class="nr user-assets-name row" style="color: #8F430E">累计收益<u-icon class="ml10" name="question-circle" size="30rpx" color="#D88D5A" /></view>
                        <view class="assets">
    ...
    <u-popup v-model="showPop" @close="onClose" mode="center" border-radius="30">
        <view class="inviteformContain column-center">
            ...
            <view class="input-row row">
                ...
                <input v-model="inviteCode" placeholder="请输入邀请码"></input>
            </view>
...
export default {
  ...
  methods: {
    ...
    veryfiyDistributeFun() {
        veryfiyDistribute().then(async (res) => {
            if(res.code == 10001) {
                this.vipState = 2
                // 填写表单
                await this.getInviteInfoFun();
