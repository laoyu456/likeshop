...
<view class="container">
  <view class="my-lottery row-between wrap" v-if="status">
    <view v-for="(item, index) in lotteryData" :key="index" :class="(item.type == 1 ? 'lotty-btn' : 'lottery-item') + ' column-center ' + (activeIndex == index ? 'active' : '')" style="width: 180rpx;height: 180rpx;" @tap="onLotteryClick" :data-type="item.type">
