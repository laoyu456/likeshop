	...
	<view class="uni-cursor-point">
		  ...
		  'uni-fab__content--other-platform': !isAndroidNvue
			 ...
			 elevation="5">
				...
				<block v-for="(item, index) in content" :key="index">
					<block v-if="item.text=='客服'">
					    <!-- #ifdef MP-WEIXIN -->
							<button open-type="contact"    :class="{ 'uni-fab__item--active': isShow }" class="uni-fab__item"
							 >
							
								<view class="contact-bnt">
									<text :class="'iconfont icon-'+item.iconPath" :style="{ color: item.active ? styles.selectedColor : styles.color }"></text>
								</view>
					...
					<block v-else>
						<view   :class="{ 'uni-fab__item--active': isShow }" class="uni-fab__item"
		...
		<view :class="{
		 ...
		 class="uni-fab__circle uni-fab__plus" :style="{ 'background-color': styles.buttonColor }" @click="_onClick">
		    <text class="iconfont icon-dianhua2 ky-bnt" :class="{'uni-fab__plus--mactive': isShow && content.length > 0}"></text>
