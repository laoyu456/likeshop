...
<view class="goods-like">
    ...
    <view class="goods">
        <scroll-view style="height: 340rpx; white-space: nowrap;" scroll-x="true" scroll-with-animation="true" @scroll="scrollBarChange">
            <navigator v-for="(item, index) in list" :key="index" hover-class="none" :url="'/pages/goods_details/goods_details?id=' + item.id" class="goods-item">
                ...
                <view class="price">
                    <price-format  color="#FF2C3C" :subscript-size="22" :second-size="22" :price="item.price" :weight="500"></price-format>
                    <price-format class="ml10" :show-subscript="true" color="#999" :line-through="true" :subscript-size="22" :first-size="22" :second-size="22" :price="item.market_price"></price-format>
                </view>
            </navigator>
        </scroll-view>
